...
<div class="navbar">
        ...
        $sql = "INSERT INTO attendancerecords (StudentName, RollNo, ContactNo, EmailId, PassWord1, CourseCode, CourseTitle)  VALUES('$StudentName','$RollNo','$ContactNo','$EmailId','$Password', '$CourseCode','$CourseTitle')";
