    ...
    <style>
        * {
        ...
        .piechart_att {
            ...
            height: 200px;
            border-radius: 50%;
            background: conic-gradient(red 0deg 237deg, yellow 237deg 360deg);
        }
    </style>
    <script>
        function logout() {
...
<body>
    ...
    <div class="container">
        <div class="containerq">
            ...
            <p>Classes Attended: 20</p>
            <p>Attendance percentage: 67% </p>
            <p>Leave Approved: 0</p>
            <P>Final percentage: 67%</P>
